...
module.exports = {
    ping: {
        description: "Vérifie si MiyuBot répond"
    },
    help: {
        description: "Liste des commandes MiyuBot"
    },
    userinfo: {
    ...
    ban: {
        ...
        options: [
            userOpt("membre", "Membre à bannir"),
    ...
    unban: {
        ...
        options: [
            strOpt("utilisateur", "ID Discord", true),
            strOpt("raison", "Raison")
        ]
    },
    kick: {
        ...
        options: [
            userOpt("membre", "Membre à expulser"),
            strOpt("raison", "Raison")
        ]
    },
    timeout: {
    ...
    nick: {
        ...
        options: [
            userOpt("membre", "Membre"),
            strOpt("pseudo", "Nouveau pseudo, ou reset")
        ]
    },
    nickname: {
    ...
    setupcheck: {
        description: "Vérifie la config de sécurité"
    },
    syncmembers: {
        description: "Synchronise les membres en base"
    },
    config: {
        ...
        options: [
            strOpt(
                "parametres",
                "Ex: show, age 30, raid on, logs off",
                false
            ),
            {
                name: "salon",
                description: "Salon (pour logs)",
                type: CHANNEL,
                required: false
            },
            {
    ...
    antinuke: {
        ...
        options: [
            strOpt(
                "action",
                "status, on, off, threshold, window, sanction",
                false
            ),
